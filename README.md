...
**Placement.** Segregating neurons by function (the intuitive, wire-length-optimal choice) puts correlated partners beyond the reach of local plasticity rules - some associations become structurally impossible to learn. Interleaving avoids this at negligible energy cost. See `src/experiments/exp32b_benchmark.py`.
