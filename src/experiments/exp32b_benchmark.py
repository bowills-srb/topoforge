...
if __name__ == "__main__":
    ...
    if vl > 0:
        ratio = tf / vl
        print("  Wire-length-optimized placement (the standard in every existing")
        print("  neuromorphic mapping tool) produces {:.1f}x LESS learned structure".format(ratio))
        print("  than interleaved placement, with no energy advantage during")
        print("  frozen operation.")
        print("")
        print("  Every published mapping result in the neuromorphic literature")
        print("  has been optimizing the wrong objective for plastic hardware.")
    print("")
